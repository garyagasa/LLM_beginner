...
class CharTokenizer:
    ...
    def __init__(self, vocab: dict[str, int]):
        ...
        raise NotImplementedError("TODO: 实现 CharTokenizer.__init__ — 约 5 行")

    def __len__(self) -> int:
        # TODO: 返回词表大小
        raise NotImplementedError("TODO: 实现 CharTokenizer.__len__ — 1 行")
    ...
    def encode(self, text: str, add_cls: bool = True) -> list[int]:
        ...
        # ---- 你的代码开始 ----
        # TODO: 实现编码逻辑（约 6 行）
        raise NotImplementedError("TODO: 实现 CharTokenizer.encode — 约 6 行")
        # ---- 你的代码结束 ----

    def decode(self, ids: list[int]) -> str:
        """将 token id 列表解码回文本。"""
        # TODO: 逐 id 查 self.idx_to_char，拼接返回
        raise NotImplementedError("TODO: 实现 CharTokenizer.decode — 约 2 行")
    ...
    def build_from_texts(cls, texts: list[str], min_freq: int = 1) -> "CharTokenizer":
        ...
        #         vocab[ch] = len(vocab)
        # return cls(vocab)
        raise NotImplementedError("TODO: 实现 CharTokenizer.build_from_texts — 约 10 行")
        # ---- 你的代码结束 ----
    ...
    def to_dict(self) -> dict:
        ...
        raise NotImplementedError("TODO: 实现 CharTokenizer.to_dict — 1 行")

    @classmethod
    def from_dict(cls, d: dict) -> "CharTokenizer":
        """从 dict 恢复 tokenizer。"""
        # TODO: return cls(vocab=d["vocab"])
        raise NotImplementedError("TODO: 实现 CharTokenizer.from_dict — 1 行")
...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, max_len: int = 512, dropout: float = 0.1):
        ...
        raise NotImplementedError("TODO: 实现 PositionalEncoding.__init__ — 约 10 行")
        # ---- 你的代码结束 ----

    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """x: (B, T, d_model)，加上位置编码后返回。"""
        # TODO: return self.dropout(x + self.pe[:, : x.size(1), :])
        raise NotImplementedError("TODO: 实现 PositionalEncoding.forward — 1 行")
...
class TransformerClassifier(nn.Module):
    ...
    def __init__(
        ...
        raise NotImplementedError("TODO: 实现 TransformerClassifier.__init__ — 约 15 行")
        # ---- 你的代码结束 ----
    ...
    def _create_padding_mask(self, input_ids: torch.Tensor) -> torch.Tensor:
        ...
        raise NotImplementedError("TODO: 实现 _create_padding_mask — 约 2 行")
    ...
    def forward(
        ...
        raise NotImplementedError("TODO: 实现 TransformerClassifier.forward — 约 10 行")
        # ---- 你的代码结束 ----
...
def load_for_eval(ckpt_path: str):
    ...
    raise NotImplementedError("TODO: 实现 load_for_eval — 约 15 行")
    # ---- 你的代码结束 ----
...
def save_checkpoint(
    ...
    **extra,
    ...
    # TODO: 4. print 保存路径
    raise NotImplementedError("TODO: 实现 save_checkpoint — 约 8 行")
    # ---- 你的代码结束 ----
